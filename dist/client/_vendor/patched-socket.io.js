 ...
 *
 * @api private
 */if('undefined'!=typeof navigator&&'undefined'!=typeof navigator.userAgent&&/iPad|iPhone|iPod/i.test(navigator.userAgent)){WS.prototype.onData=function(data){var self=this;setTimeout(function(){Transport.prototype.onData.call(self,data);},0);};} /**
